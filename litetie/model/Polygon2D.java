...
//		this.ypoints = new double[npoints];
//		System.arraycopy(xpoints, 0, this.xpoints, 0, npoints);
//		System.arraycopy(ypoints, 0, this.ypoints, 0, npoints);// TODO Auto-generated constructor stub
//	}
	...
	private LTCrossings getCrossings(double xlo, double ylo, double xhi,
		double yhi)
	{
		LTCrossings cross = new LTCrossings.EvenOdd(xlo, ylo, xhi, yhi);
		double lastx = xpoints[npoints - 1];
		double lasty = ypoints[npoints - 1];
		double curx;
		double cury;
	...
	public boolean intersects(double x, double y, double w, double h)
	{
		...
		LTCrossings cross = getCrossings(x, y, x + w, y + h);
