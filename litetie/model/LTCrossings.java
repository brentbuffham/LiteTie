...
public abstract class LTCrossings {
    ...
    public LTCrossings(double xlo, double ylo, double xhi, double yhi) {
        this.xlo = xlo;
        this.ylo = ylo;
        this.xhi = xhi;
        this.yhi = yhi;
    ...
    public static LTCrossings findCrossings(Vector curves,
                                          double xlo, double ylo,
                                          double xhi, double yhi)
    {
        LTCrossings cross = new EvenOdd(xlo, ylo, xhi, yhi);
        Enumeration enum_ = curves.elements();
        while (enum_.hasMoreElements()) {
            LTCurve c = (LTCurve) enum_.nextElement();
    ...
    public static LTCrossings findCrossings(PathIterator pi,
                                          double xlo, double ylo,
                                          double xhi, double yhi)
    {
        LTCrossings cross;
    ...
    public boolean accumulateQuad(double x0, double y0, double coords[]) {
        ...
        LTCurve.insertQuad(tmp, x0, y0, coords);
    ...
    public boolean accumulateCubic(double x0, double y0, double coords[]) {
        ...
        LTCurve.insertCubic(tmp, x0, y0, coords);
        Enumeration enum_ = tmp.elements();
        while (enum_.hasMoreElements()) {
            LTCurve c = (LTCurve) enum_.nextElement();
            if (c.accumulateCrossings(this)) {
    ...
    public final static class EvenOdd extends LTCrossings {
    ...
    public final static class NonZero extends LTCrossings {
