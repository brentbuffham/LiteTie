...
public class Polyline2D implements Shape, Cloneable, Serializable {
     ...
     * parameters.
     * @param xPoints2 an array of <i>x</i> coordinates
     * @param yPoints2 an array of <i>y</i> coordinates
     ...
     */
    public Polyline2D(double[] xPoints2, double[] yPoints2, int npoints) {
        if (npoints > xPoints2.length || npoints > yPoints2.length) {
        ...
        System.arraycopy(xPoints2, 0, this.xpoints, 0, npoints);
        System.arraycopy(yPoints2, 0, this.ypoints, 0, npoints);
        calculatePath();
    }
    ...
    private void updatePath(double xpoints2, double ypoints2) {
        closedPath = null;
        if (path == null) {
            path = new GeneralPath(GeneralPath.WIND_EVEN_ODD);
            path.moveTo(xpoints2, ypoints2);
            bounds = new Rectangle2D.Double(xpoints2, ypoints2, 0, 0);
        } else {
            path.lineTo(xpoints2, ypoints2);
            double _xmax = bounds.getMaxX();
            double _ymax = bounds.getMaxY();
            double _xmin = bounds.getMinX();
            double _ymin = bounds.getMinY();
            if (xpoints2 < _xmin) _xmin = xpoints2;
            else if (xpoints2 > _xmax) _xmax = xpoints2;
            if (ypoints2 < _ymin) _ymin = ypoints2;
            else if (ypoints2 > _ymax) _ymax = ypoints2;
     ...
     * @param       xpoints2 the specified x coordinate
     * @param       ypoints2 the specified y coordinate
     * @see         java.awt.Polygon#getBounds
     * @see         java.awt.Polygon#contains(double,double)
     */
    public void addPoint(double xpoints2, double ypoints2) {
        ...
        xpoints[npoints] = xpoints2;
        ypoints[npoints] = ypoints2;
        npoints++;
        updatePath(xpoints2, ypoints2);
    }
