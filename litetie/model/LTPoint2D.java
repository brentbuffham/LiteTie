 ...
 * @since 1.2
 */
public abstract class LTPoint2D implements Cloneable {
     ...
     * @since 1.2
     */
    public static class Float extends LTPoint2D implements Serializable {
        /**
     ...
     * @since 1.2
     */
    public static class Double extends LTPoint2D implements Serializable {
        /**
         * The X coordinate of this {@code Point2D}.
         * @since 1.2
         * @serial
     ...
     * @since 1.2
     */
    public void setLocation(LTPoint2D p) {
     ...
     * @since 1.2
     */
    public double distanceSq(LTPoint2D pt) {
     ...
     * @since 1.2
     */
    public double distance(LTPoint2D pt) {
        double px = pt.getX() - this.getX();
        double py = pt.getY() - this.getY();
        return Math.sqrt(px * px + py * py);
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof LTPoint2D) {
            LTPoint2D p2d = (LTPoint2D) obj;
