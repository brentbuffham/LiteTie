...
public abstract class LTCurve {
    ...
    public final LTCurve getWithDirection(int direction) {
    ...
    public boolean accumulateCrossings(LTCrossings c) {
        double xhi = c.getXHi();
        if (getXMin() >= xhi) {
            return false;
        }
    ...
    public LTCurve getSubCurve(double ystart, double yend) {
        return getSubCurve(ystart, yend, direction);
    }

    public abstract LTCurve getReversedCurve();
    public abstract LTCurve getSubCurve(double ystart, double yend, int dir);

    public int compareTo(LTCurve that, double yrange[]) {
        /*
    ...
    public boolean findIntersect(LTCurve that, double yrange[], double ymin,
