...
final class Order1 extends LTCurve {
    private double x0;
    private double y0;
    private double x1;
    private double y1;
    ...
    public LTCurve getSubCurve(double ystart, double yend, int dir) {
    ...
    public LTCurve getReversedCurve() {
        return new Order1(x0, y0, x1, y1, -direction);
    }

    public int compareTo(LTCurve other, double yrange[]) {
